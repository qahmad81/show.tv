<template>
    <div>
        <form method="post" enctype="multipart/form-data" @submit.prevent="submitEpisode">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="duration" name="duration" 
                     v-model="form1.duration" placeholder="Please set Airing Time her"
...
<script>
    export default {
        props: ['serieses', 'episode', 'submiturl', 'token1'],
        data() {
            return{
                img1: this.episode.img,
                vid1: this.episode.vid,
                loading: '',
                form1: new Form({
                    ...
                    airing_time: this.episode.airing_time
                })
            }
        },
        methods:{
